...
```bash
pnpm exec tsx .Codex/skills/design-check/scripts/capture-figma-screenshot.ts \
  --url "{figmaUrl}" \
...
```bash
pnpm exec tsx .Codex/skills/component-screenshot/scripts/capture-screenshot.ts \
  --story-id "{story-id}" \
...
```bash
pnpm exec tsx .Codex/skills/design-check/scripts/compare-screenshots.ts \
