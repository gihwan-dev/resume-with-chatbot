...
# Codex Command: Figma Design Pipeline
...
`.Codex/skills/figma-to-code/SKILL.md`를 읽고 해당 워크플로우 전체(Phase 1~6)를 실행합니다.
...
`.Codex/skills/design-check/SKILL.md`를 읽고 해당 워크플로우 전체(Phase 1~7)를 실행합니다.
