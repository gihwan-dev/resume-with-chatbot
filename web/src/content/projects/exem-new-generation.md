...
priority: 3
summary: "차세대 DB 모니터링 제품에서 위젯 빌더, 상태 관리, 저장소 추상화, SQL 분석 UX를 담당했습니다. 전역 Zustand 스토어를 Context 기반 지역 스토어로 전환해 상태 변경 경계를 화면 단위로 좁히고, 저장 엔진 추상화로 레이아웃 저장 방식을 교체 가능한 구조로 만들었습니다."
accomplishments:
