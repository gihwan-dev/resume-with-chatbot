...
accomplishments:
  ...
  - "Design Studio 템플릿에 page/i18n/screen-spec/policy 문서 스캐폴딩·검증, iframe 미리보기 격리, page-level lock/Git sync/eval suite를 연결해 기획자 자연어 요구를 페이지 단위 산출물로 검증하는 하네스를 구축했습니다."
