...
export const INTENT_KEYWORDS: Record<UserIntent, string[]> = {
  career_inquiry: [
    // 경력/프로젝트 관련
    "경력", "프로젝트", "업무", "담당", "개발", "구현", "진행",
    "성과", "기여", "맡", "했", "하셨", "어떤 일", "무슨 일",
    "work", "project", "experience", "career", "responsibility",
    // 회사/직장 관련
    "회사", "팀", "부서", "역할", "직무",
    // 기간/상태 관련
    "현재", "최근", "요즘", "지금",
  ...
  technical_inquiry: [
    ...
    "extjs", "radix", "tanstack", "vitest", "astro",
    // 기술적 개념
    "구현", "아키텍처", "설계", "패턴", "컴포넌트", "api",
    "테스트", "배포", "CI/CD", "성능", "최적화",
    "가상화", "virtualization", "데이터그리드", "datagrid",
    // 기술적 질문 패턴
    "어떻게", "왜", "방법", "원리", "구조",
    "tech", "stack", "how", "implement",
  ],
  contact_inquiry: [
    // 연락처 관련
    "연락", "이메일", "메일", "email", "전화", "phone",
    "깃허브", "github", "링크드인", "linkedin",
    "블로그", "blog", "포트폴리오", "portfolio",
    "사이트", "site", "주소", "url",
    // 연락 의도
    "연락처", "contact", "reach", "get in touch",
    "문의", "컨택", "연결",
  ],
  general_chat: [
    // 인사/일반
 ...
 */
export function analyzeToolCallPattern(steps: Array<{ toolCalls?: Array<{ toolName: string; args?: unknown }> }>): StepAnalysis {
