...
export const RESUME_PORTFOLIO_CONTENT_V2: ResumePortfolioContentItem[] = [
  {
    ...
    resumeSummary:
      "300~3,000대 인스턴스를 다루는 운영 대시보드에서 카드형 UI를 고밀도 그리드로 전환하고 제품 이동 동선을 1단계로 줄였습니다. 드래그/리사이즈 중 데이터 반영 시점과 렌더 우선순위를 조정해 위젯 5개 드래그 30틱 기준 총 렌더를 150회에서 5회로 줄였습니다.",
    accomplishments: [
      "화면마다 흩어진 폴링 타이머를 객체 추상화(`restart/add/stop`)로 통합해 갱신 주기 제어를 일원화했습니다.",
      "필터/조회 상태를 중앙 저장소로 옮기고 버전 기반 마이그레이션을 적용해 변경 영향 범위를 예측할 수 있게 했습니다.",
      "API 전면 교체 시점에 Vue 연장을 멈추고 React + 사내 디자인 시스템으로 재구축해 구조 부채 누적을 줄였습니다.",
      "카드형 UI를 고밀도 그리드로 바꾸고 제품 간 이동 동선을 1단계로 줄여 한 화면 비교와 즉시 이동 흐름을 확보했습니다.",
      "드래그/리사이즈 상태 추적, 데이터 동결/지연 렌더링, 메모이제이션 기반 최적화로 렌더 경합을 줄여 위젯 5개 드래그 30틱 기준 총 렌더를 150회에서 5회로 낮췄습니다.",
    ],
    hasPortfolio: true,
