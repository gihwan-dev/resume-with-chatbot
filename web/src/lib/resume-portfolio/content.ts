...
export const RESUME_PORTFOLIO_CONTENT_V2: ResumePortfolioContentItem[] = [
  {
    ...
    resumeSummary:
      "300~3,000대 인스턴스를 다루는 운영 대시보드에서 카드형 UI를 고밀도 그리드로 전환하고 제품 이동 동선을 1단계로 줄였습니다. 인터랙션 구간의 상태 반영 우선순위를 조정해 조작 지연 73~82% 개선과 이상 징후 인지 시간 10초→3초 단축을 확인했습니다.",
    accomplishments: [
      ...
      "알림 기능은 통합 테스트로 스펙을 먼저 고정한 뒤 마이그레이션해 회귀 기준을 명확히 했습니다.",
    ],
    hasPortfolio: true,
